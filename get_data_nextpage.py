...
def get_data_next_page():
    ...
    while next_page_val < 2:
        cod_data_url = f"https://api.tracker.gg/api/v1/cold-war/matches/xbl/Cording%20Xx?type=mp&next={next_page_val}"
